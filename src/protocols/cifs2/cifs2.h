...
{
    SERVER_TO_REDIR      = 0x01000000, //!< When set, indicates the message is a response, rather than a request. This MUST be set on responses sent from the server to the client and MUST NOT be set on requests sent from the client to the server.
    ASYNC_COMMAND        = 0x02000000, //!< When set, indicates that this is an ASYNC SMB2 header. This flag MUST NOT be set when using the SYNC SMB2 header.
    RELATED_OPERATIONS   = 0x04000000, //!< When set in an SMB2 request, indicates that this request is a related operation in a compounded request chain. The use of this flag in an SMB2 request is as specified in 3.2.4.1.4.
    ...
    SIGNED               = 0x08000000, //!< When set, indicates that this packet has been signed. The use of this flag is as specified in 3.1.5.1.
    DFS_OPERATIONS       = 0x00000001, //!< When set, indicates that this command is a DFS operation. The use of this flag is as specified in 3.3.5.9.
    REPLAY_OPERATION     = 0x00000002  //!< This flag is only valid for the SMB 3.x dialect family. When set, it indicates that this command is a replay operation. The client MUST ignore this bit on receipt.
};
