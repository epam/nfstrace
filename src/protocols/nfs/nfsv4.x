...
/* FRED - the following constants are used, but not defined,
 * so for ease of use, define them here.
 */
const RPCSEC_GSS = 6;
const FALSE=0;
const TRUE=1;
...
/*
 * Notification types (for notification_types4)
 */
const DIR_NOTIFICATION_NONE			= 0x00000000;
const DIR_NOTIFICATION_CHANGE_ENTRY_ATTRIBUTES	= 0x00000001;
...
/*
 * GET_DIR_DELEGATION: request a delegation on a directory
 */
