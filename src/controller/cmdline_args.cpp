...
Opt Args::options[Args::num] =
{
    ...
    {'I', "ifile",      Opt::REQ, "INTERFACE-PORT.pcap", "input file to "STAT" mode",                           "PATH"},
    {'O', "ofile",      Opt::REQ, "INTERFACE-PORT.pcap", "output file to "DUMP" mode",                          "PATH"},
    {'C', "compression",Opt::NOA, "false",               "compression input/output data from/to zip archive",   "true|false"},
