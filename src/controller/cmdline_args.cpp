...
Opt Args::options[Args::num] =
{
    ...
    {'t', "timeout",    Opt::REQ, "250",                 "set the read timeout that will be used on a capture", "Milliseconds"},
    ...
    {'D', "dump-size",  Opt::REQ, "0",                   "size of dumping file portion, 0 = no limit",          "MBytes"},
    {'B', "bsize",      Opt::REQ, "20",                  "size of capturing kernel buffer",                     "MBytes"},
