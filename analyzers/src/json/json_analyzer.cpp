...
void JsonAnalyzer::access40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::close40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::commit40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::create40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::delegpurge40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::delegreturn40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getattr40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getfh40(const struct RPCProcedure* /* proc */,
                           const struct NFS4::GETFH4res* res)
{
    if(res) _nfsV40Stat.getfhOpsAmount++;
}

void JsonAnalyzer::link40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lock40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lockt40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::locku40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lookup40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lookupp40(const struct RPCProcedure* /* proc */,
                             const struct NFS4::LOOKUPP4res* res)
{
    if(res) _nfsV40Stat.lookuppOpsAmount++;
}

void JsonAnalyzer::nverify40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::openattr40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open_confirm40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open_downgrade40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::putfh40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::putpubfh40(const struct RPCProcedure* /* proc */,
                              const struct NFS4::PUTPUBFH4res* res)
{
    if(res) _nfsV40Stat.putpubfhOpsAmount++;
}

void JsonAnalyzer::putrootfh40(const struct RPCProcedure* /* proc */,
                               const struct NFS4::PUTROOTFH4res* res)
{
    if(res) _nfsV40Stat.putrootfhOpsAmount++;
}

void JsonAnalyzer::read40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::readdir40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::readlink40(const struct RPCProcedure* /* proc */,
                              const struct NFS4::READLINK4res* res)
{
    if(res) _nfsV40Stat.readlinkOpsAmount++;
}

void JsonAnalyzer::remove40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::rename40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::renew40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::restorefh40(const struct RPCProcedure* /* proc */,
                               const struct NFS4::RESTOREFH4res* res)
{
    if(res) _nfsV40Stat.restorefhOpsAmount++;
}

void JsonAnalyzer::savefh40(const struct RPCProcedure* /* proc */,
                            const struct NFS4::SAVEFH4res* res)
{
    if(res) _nfsV40Stat.savefhOpsAmount++;
}

void JsonAnalyzer::secinfo40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setattr40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setclientid40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setclientid_confirm40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::verify40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::write40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::release_lockowner40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::get_dir_delegation40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::illegal40(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::null41(const struct RPCProcedure* /*proc*/,
                          const struct NFS41::NULL4args* /*args*/,
                          const struct NFS41::NULL4res* /*res*/)
{
    _nfsV41Stat.nullProcsAmount++;
}
void JsonAnalyzer::compound41(const struct RPCProcedure* /*proc*/,
...
void JsonAnalyzer::access41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::close41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::commit41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::create41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::delegpurge41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::delegreturn41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getattr41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getfh41(const struct RPCProcedure* /* proc */,
                           const struct NFS41::GETFH4res* res)
{
    if(res) _nfsV41Stat.getfhOpsAmount++;
}

void JsonAnalyzer::link41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lock41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lockt41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::locku41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lookup41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::lookupp41(const struct RPCProcedure* /* proc */,
                             const struct NFS41::LOOKUPP4res* res)
{
    if(res) _nfsV41Stat.lookuppOpsAmount++;
}

void JsonAnalyzer::nverify41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::openattr41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open_confirm41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::open_downgrade41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::putfh41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::putpubfh41(const struct RPCProcedure* /* proc */,
                              const struct NFS41::PUTPUBFH4res* res)
{
    if(res) _nfsV41Stat.putpubfhOpsAmount++;
}

void JsonAnalyzer::putrootfh41(const struct RPCProcedure* /* proc */,
                               const struct NFS41::PUTROOTFH4res* res)
{
    if(res) _nfsV41Stat.putrootfhOpsAmount++;
}

void JsonAnalyzer::read41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::readdir41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::readlink41(const struct RPCProcedure* /* proc */,
                              const struct NFS41::READLINK4res* res)
{
    if(res) _nfsV41Stat.readlinkOpsAmount++;
}

void JsonAnalyzer::remove41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::rename41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::renew41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::restorefh41(const struct RPCProcedure* /* proc */,
                               const struct NFS41::RESTOREFH4res* res)
{
    if(res) _nfsV41Stat.restorefhOpsAmount++;
}

void JsonAnalyzer::savefh41(const struct RPCProcedure* /* proc */,
                            const struct NFS41::SAVEFH4res* res)
{
    if(res) _nfsV41Stat.savefhOpsAmount++;
}

void JsonAnalyzer::secinfo41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setattr41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setclientid41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::setclientid_confirm41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::verify41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::write41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::release_lockowner41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::backchannel_ctl41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::bind_conn_to_session41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::exchange_id41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::create_session41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::destroy_session41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::free_stateid41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::get_dir_delegation41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getdeviceinfo41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::getdevicelist41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::layoutcommit41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::layoutget41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::layoutreturn41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::secinfo_no_name41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::sequence41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::set_ssv41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::test_stateid41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::want_delegation41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::destroy_clientid41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::reclaim_complete41(const struct RPCProcedure* /* proc */,
...
void JsonAnalyzer::illegal41(const struct RPCProcedure* /* proc */,
