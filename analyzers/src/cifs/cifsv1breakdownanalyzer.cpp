...
{
    account(cmd, SMBv1Commands::CREATE_DIRECTORY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CREATE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CLOSE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::FLUSH, smbv1);
}
...
{
    account(cmd, SMBv1Commands::DELETE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::RENAME, smbv1);
}
...
{
    account(cmd, SMBv1Commands::QUERY_INFORMATION, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::LOCK_BYTE_RANGE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::UNLOCK_BYTE_RANGE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CREATE_TEMPORARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CREATE_NEW, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CHECK_DIRECTORY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::LOCK_AND_READ, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_AND_UNLOCK, smbv1);
}
...
{
    account(cmd, SMBv1Commands::READ_RAW, smbv1);
}
...
{
    account(cmd, SMBv1Commands::READ_MPX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::READ_MPX_SECONDARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_RAW, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_MPX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_MPX_SECONDARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_COMPLETE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::QUERY_SERVER, smbv1);
}
...
{
    account(cmd, SMBv1Commands::SET_INFORMATION2, smbv1);
}
...
{
    account(cmd, SMBv1Commands::QUERY_INFORMATION2, smbv1);
}
...
{
    account(cmd, SMBv1Commands::LOCKING_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TRANSACTION, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TRANSACTION_SECONDARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::IOCTL, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_AND_CLOSE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::OPEN_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::READ_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NEW_FILE_SIZE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CLOSE_AND_TREE_DISC, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TRANSACTION2, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TRANSACTION2_SECONDARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::FIND_CLOSE2, smbv1);
}
...
{
    account(cmd, SMBv1Commands::FIND_NOTIFY_CLOSE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TREE_CONNECT, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TREE_DISCONNECT, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NEGOTIATE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::SESSION_SETUP_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::LOGOFF_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::TREE_CONNECT_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::SECURITY_PACKAGE_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::QUERY_INFORMATION_DISK, smbv1);
}
...
{
    account(cmd, SMBv1Commands::FIND_UNIQUE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::FIND_CLOSE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NT_TRANSACT, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NT_TRANSACT_SECONDARY, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NT_CREATE_ANDX, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NT_CANCEL, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NT_RENAME, smbv1);
}
...
{
    account(cmd, SMBv1Commands::OPEN_PRINT_FILE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_PRINT_FILE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::CLOSE_PRINT_FILE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::GET_PRINT_QUEUE, smbv1);
}
...
{
    account(cmd, SMBv1Commands::READ_BULK, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_BULK, smbv1);
}
...
{
    account(cmd, SMBv1Commands::WRITE_BULK_DATA, smbv1);
}
...
{
    account(cmd, SMBv1Commands::INVALID, smbv1);
}
...
{
    account(cmd, SMBv1Commands::NO_ANDX_COMMAND, smbv1);
}
