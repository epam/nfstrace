...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CREATE_DIRECTORY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_DELETE_DIRECTORY, smbv1);
}

void CIFSBreakdownAnalyzer::openSMBv1(const SMBv1::OpenCommand* cmd, const SMBv1::OpenArgumentType*, const SMBv1::OpenResultType*)
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_OPEN, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CREATE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CLOSE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_FLUSH, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_DELETE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_RENAME, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_QUERY_INFORMATION, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_SET_INFORMATION, smbv1);
}

void CIFSBreakdownAnalyzer::readSMBv1(const SMBv1::ReadCommand* cmd, const SMBv1::ReadArgumentType*, const SMBv1::ReadResultType*)
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_LOCK_BYTE_RANGE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_UNLOCK_BYTE_RANGE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CREATE_TEMPORARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CREATE_NEW, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CHECK_DIRECTORY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_PROCESS_EXIT, smbv1);
}

void CIFSBreakdownAnalyzer::seekSMBv1(const SMBv1::SeekCommand* cmd, const SMBv1::SeekArgumentType*, const SMBv1::SeekResultType*)
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_SEEK, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_LOCK_AND_READ, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_AND_UNLOCK, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ_RAW, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ_MPX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ_MPX_SECONDARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_RAW, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_MPX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_MPX_SECONDARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_COMPLETE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_QUERY_SERVER, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_SET_INFORMATION2, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_QUERY_INFORMATION2, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_LOCKING_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TRANSACTION, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TRANSACTION_SECONDARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_IOCTL, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_AND_CLOSE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_OPEN_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NEW_FILE_SIZE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CLOSE_AND_TREE_DISC, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TRANSACTION2, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TRANSACTION2_SECONDARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_FIND_CLOSE2, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_FIND_NOTIFY_CLOSE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TREE_CONNECT, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TREE_DISCONNECT, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NEGOTIATE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_SESSION_SETUP_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_LOGOFF_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_TREE_CONNECT_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_SECURITY_PACKAGE_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_QUERY_INFORMATION_DISK, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_FIND_UNIQUE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_FIND_CLOSE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NT_TRANSACT, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NT_TRANSACT_SECONDARY, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NT_CREATE_ANDX, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NT_CANCEL, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NT_RENAME, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_OPEN_PRINT_FILE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_PRINT_FILE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_CLOSE_PRINT_FILE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_GET_PRINT_QUEUE, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_READ_BULK, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_BULK, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_WRITE_BULK_DATA, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_INVALID, smbv1);
}
...
{
    account(cmd, NST::API::SMBv1::SMBv1Commands::SMB_COM_NO_ANDX_COMMAND, smbv1);
}
