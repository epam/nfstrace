...
{
    statistics.account(cmd, SMBv1Commands::CREATE_DIRECTORY);
}
...
{
    statistics.account(cmd, SMBv1Commands::CREATE);
}
...
{
    statistics.account(cmd, SMBv1Commands::CLOSE);
}
...
{
    statistics.account(cmd, SMBv1Commands::FLUSH);
}
...
{
    statistics.account(cmd, SMBv1Commands::DELETE);
}
...
{
    statistics.account(cmd, SMBv1Commands::RENAME);
}
...
{
    statistics.account(cmd, SMBv1Commands::QUERY_INFORMATION);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE);
}
...
{
    statistics.account(cmd, SMBv1Commands::LOCK_BYTE_RANGE);
}
...
{
    statistics.account(cmd, SMBv1Commands::UNLOCK_BYTE_RANGE);
}
...
{
    statistics.account(cmd, SMBv1Commands::CREATE_TEMPORARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::CREATE_NEW);
}
...
{
    statistics.account(cmd, SMBv1Commands::CHECK_DIRECTORY);
}
...
{
    statistics.account(cmd, SMBv1Commands::LOCK_AND_READ);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_AND_UNLOCK);
}
...
{
    statistics.account(cmd, SMBv1Commands::READ_RAW);
}
...
{
    statistics.account(cmd, SMBv1Commands::READ_MPX);
}
...
{
    statistics.account(cmd, SMBv1Commands::READ_MPX_SECONDARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_RAW);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_MPX);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_MPX_SECONDARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_COMPLETE);
}
...
{
    statistics.account(cmd, SMBv1Commands::QUERY_SERVER);
}
...
{
    statistics.account(cmd, SMBv1Commands::SET_INFORMATION2);
}
...
{
    statistics.account(cmd, SMBv1Commands::QUERY_INFORMATION2);
}
...
{
    statistics.account(cmd, SMBv1Commands::LOCKING_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::TRANSACTION);
}
...
{
    statistics.account(cmd, SMBv1Commands::TRANSACTION_SECONDARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::IOCTL);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_AND_CLOSE);
}
...
{
    statistics.account(cmd, SMBv1Commands::OPEN_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::READ_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::NEW_FILE_SIZE);
}
...
{
    statistics.account(cmd, SMBv1Commands::CLOSE_AND_TREE_DISC);
}
...
{
    statistics.account(cmd, SMBv1Commands::TRANSACTION2);
}
...
{
    statistics.account(cmd, SMBv1Commands::TRANSACTION2_SECONDARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::FIND_CLOSE2);
}
...
{
    statistics.account(cmd, SMBv1Commands::FIND_NOTIFY_CLOSE);
}
...
{
    statistics.account(cmd, SMBv1Commands::TREE_CONNECT);
}
...
{
    statistics.account(cmd, SMBv1Commands::TREE_DISCONNECT);
}
...
{
    statistics.account(cmd, SMBv1Commands::NEGOTIATE);
}
...
{
    statistics.account(cmd, SMBv1Commands::SESSION_SETUP_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::LOGOFF_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::TREE_CONNECT_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::SECURITY_PACKAGE_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::QUERY_INFORMATION_DISK);
}
...
{
    statistics.account(cmd, SMBv1Commands::FIND_UNIQUE);
}
...
{
    statistics.account(cmd, SMBv1Commands::FIND_CLOSE);
}
...
{
    statistics.account(cmd, SMBv1Commands::NT_TRANSACT);
}
...
{
    statistics.account(cmd, SMBv1Commands::NT_TRANSACT_SECONDARY);
}
...
{
    statistics.account(cmd, SMBv1Commands::NT_CREATE_ANDX);
}
...
{
    statistics.account(cmd, SMBv1Commands::NT_CANCEL);
}
...
{
    statistics.account(cmd, SMBv1Commands::NT_RENAME);
}
...
{
    statistics.account(cmd, SMBv1Commands::OPEN_PRINT_FILE);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_PRINT_FILE);
}
...
{
    statistics.account(cmd, SMBv1Commands::CLOSE_PRINT_FILE);
}
...
{
    statistics.account(cmd, SMBv1Commands::GET_PRINT_QUEUE);
}
...
{
    statistics.account(cmd, SMBv1Commands::READ_BULK);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_BULK);
}
...
{
    statistics.account(cmd, SMBv1Commands::WRITE_BULK_DATA);
}
...
{
    statistics.account(cmd, SMBv1Commands::INVALID);
}
...
{
    statistics.account(cmd, SMBv1Commands::NO_ANDX_COMMAND);
}
