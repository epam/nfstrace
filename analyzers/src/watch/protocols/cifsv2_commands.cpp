...
//------------------------------------------------------------------------------
using namespace CIFSRepresenter;
//------------------------------------------------------------------------------

const std::string SMBv2Commands::command_name(int cmd_code)
{
...
const std::string SMBv2Commands::command_description(int cmd_code)
{
    static std::map<Commands, std::string> cmdNames;
    if (cmdNames.empty())
    {
